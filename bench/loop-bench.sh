...
#
# bench/loop.fth is nested counted loops over stack arithmetic, written
...
echo "verifying every engine completes the loop..."
ok=""
for s in $ORDER; do
    ...
    elif ! grep -aq BENCH-DONE "$O/.b.out"; then
